...
from src.hierarquia.hierarquia_service import atualizar_hierarquia, obter_cargo_mais_alto
...
class HierarquiaListener(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self._task = None
        self._cargos_pendentes: set[int] = set()  # 👈 acumula cargos afetados durante a janela
