...
def normalizar_nome_item(nome: str, aliases: dict[str, str]) -> str | None:
    """Encontra o nome canônico mesmo quando o log varia acentos e espaços.

    Primeiro compara uma versão limpa do texto e depois tenta ignorar espaços,
    pois integrações podem registrar o mesmo item com grafias diferentes. Retorna
    `None` quando não há alias correspondente para que o item seja investigado.
    """
